...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : Low_Beams_Input_Pin High_Beams_Input_Pin */
  GPIO_InitStruct.Pin = Low_Beams_Input_Pin|High_Beams_Input_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : Timer_Input_Pin Extra_Momentary_Input_Pin EncoderA_Pin */
  GPIO_InitStruct.Pin = Timer_Input_Pin|Extra_Momentary_Input_Pin|EncoderA_Pin;
  ...
  /*Configure GPIO pins : PB6 EncoderB_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_6|EncoderB_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
